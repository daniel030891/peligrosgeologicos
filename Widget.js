...
function(declare, 
  ...
  return declare([BaseWidget], {
    ...
    _populateTable: function(outputJson){
        // Se obtiene el nodo que contiene los registros a ingresar
        var rowsContainer = dojo.byId("containerRowsHz");
        // Declarando variables a utilizar
        var rows = ""; var idhz = ""; var pehz = ""; var prhz = ""; var lehz = "";
        // Obteniendo la informacion de JSON
        arr = outputJson.value;
        // Eliminando todos los registros dentro de la tabla
        rowsContainer.innerHTML = "";
        // Insertando los nuevos registros en la tabla
        ...
        // Agregando los regsitros a la tabla
        ...
        // Agregando la funcionalidad de filtrado
    ...
    _zoomRow: function(evt){
      ...
      //console.log(graphicFilter[parseInt(idrow) - 1]);
